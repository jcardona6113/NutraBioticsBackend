...
namespace NutraBioticsBackend.Controllers.API
{
    public class OrderDetailsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> PutOrderDetail(int id, OrderDetail orderDetail)
        {
            ...
            if (id != orderDetail.SalesOrderDetaliId)
            {
                return BadRequest();
            }
        ...
        public async Task<IHttpActionResult> PostOrderDetail(OrderDetail orderDetail)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = orderDetail.SalesOrderDetaliId }, orderDetail);
        }
        ...
        {
            return db.OrderDetails.Count(e => e.SalesOrderDetaliId == id) > 0;
        }
    }
}