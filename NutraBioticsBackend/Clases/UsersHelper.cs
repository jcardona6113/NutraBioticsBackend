...
namespace NutraBioticsBackend.Classes
{
    public class UsersHelper : IDisposable
    {
        ...
        public static bool UpdateUserName(string currentEmail, string newEmail)
        {
            var userManager = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(userContext));
        ...
        public static void UpdatePassword(string Email, string newPassword)
        {
            ...
            var usertoUpdate = userManager.FindByEmail(Email);
            userManager.Delete(usertoUpdate);
            ...
            userManager.Create(userASP, newPassword);
        ...
        public static async Task PasswordRecovery(string email)
        {
            ...
            var subject = "NutraBiotics Password Recovery";
            var body = string.Format(@"
                <h1>NutraBiotics Password Recovery</h1>
